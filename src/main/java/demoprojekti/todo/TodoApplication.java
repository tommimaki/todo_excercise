	...
	public CommandLineRunner demo(TaskRepository repository, CategoryRepository crepository, UserRepository urepository) {
		return (args) -> {
			...
			// Create users: admin1/admin1 user2/user2
						User user1 = new User("user2", "$2a$06$3jYRJrg0ghaaypjZ/.g4SethoeA51ph3UD4kZi9oPkeMTpjKU5uo6", "user2");
						User user2 = new User("admin1", "$2a$10$0MMwY.IQqpsVc1jC8u7IJ.2rT8b0Cd3b3sfIBGV2zfgnPGtT4r0.C", "admin1");
